...
$limit = 10;
$offset = ($page - 1) * $limit;
$total = $inter->countViewed($user->id);
$rows = $inter->listViewed($user->id, $limit, $offset);
  ...
  <div class="wrap">
    <div class="card">
      ...
      <div class="list">
        ...
        <?php endforeach; ?>
        <?php if (empty($rows)): ?><p>Bạn chưa xem bài viết nào.</p><?php endif; ?>
      </div>
